...
import 'package:mobile_app/features/incidents/models/incident_model.dart'
    as _i9;
import 'package:mobile_app/services/incident_service.dart' as _i8;
...
/// A class which mocks [IncidentService].
///
/// See the documentation for Mockito's code generation for more information.
class MockIncidentService extends _i1.Mock implements _i8.IncidentService {
  MockIncidentService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<Map<String, dynamic>> createIncident(
    _i9.CreateIncident? incident,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#createIncident, [incident]),
